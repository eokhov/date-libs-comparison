...
<section>
  ...
  <div>
    ...
    <p>
      Чтобы создать объект типа <b>Duration</b> можно использовать конструктор или
      статический метод <b>from()</b>. Так же его можно можно получить используя
      метод <b>since()</b> других объектов типа Temporal
    </p>
    <p>
      При использовании метода <b>toString()</b> мы получим строку формата <b>ISO 8601</b>.
      Если вкратце
    ...
    <DemoContainer title="Методы">
      ...
      <code>Temporal.Duration.from('P1DT6H30M').toLocaleString('ru-RU') -> 1 дн. 6ч 30 мин</code>
    </DemoContainer>
  </div>
</section>
